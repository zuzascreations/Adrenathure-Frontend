    ...
    return(
      <div id='cookies'>
        ...
        <div className='bodyCookies'>
          ...
          <ul>
            <li className='mainCookies3'><span className="politica-cookies">Técnicas</span>: facilitan información sobre el uso que el usuario realiza de la web. No permiten identificar al usuario, porque la información que recogen es anónima y se utiliza únicamente para acciones de mejora que permitan que la web funcione de manera más ágil y adaptada a las preferencias de los usuarios.</li>
            <li className='mainCookies3'><span className="politica-cookies">De registro</span>: se crean tras el registro o cuando un usuario inicia sesión en la web.</li>
            <li className='mainCookies3'><span className="politica-cookies">De personalización</span>: permiten personalizar las funciones o contenidos de la web en función de los datos obtenidos del navegador.</li>
            <li className='mainCookies3'><span className="politica-cookies">Analíticas</span>: tienen fines estadísticos, de forma que la información se utiliza para medir la actividad, mediante Google Analytics, que es una herramienta gratuita de análisis web proporcionada por Google, permitiendo a los propietarios de los sitios web conocer cómo interactúan los usuarios con su sitio web.</li>
            <li className='mainCookies3'><span className="politica-cookies">Preferencias</span>: permiten saber si el usuario ha visitado antes la web. La pérdida de información almacenada en una cookie de preferencias puede hacer que la experiencia de la web sea menos funcional, pero no debe afectar a su funcionamiento.</li>
            <li className='mainCookies3'><span className="politica-cookies">Estado de la sesión</span>: guardan la información necesaria durante la sesión y los cambios relacionados con ella, y también determinan si el usuario está registrado.</li>
            <li className='mainCookies3'><span className="politica-cookies">Procesos</span>: permiten el funcionamiento de la web y ofrecen servicios esperados por el usuario que accede a la misma.</li>
          </ul>
